...
Dans ce document, vous trouverez des informations concernant la situation de la flambee de la maladie à coronavirus 2019 (COVID-19) a Madagascar dont les premiers cas ont été signalés pour la première fois à Wuhan, en Chine, le 31 décembre 2019. Cette page est mise à jour regulierement. Derniere mise a jour **`r last(na.omit(data$date))`**.
