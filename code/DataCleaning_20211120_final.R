...
data_file$diarr_u5 <- data_file$`Diarrhées aigues chez moins 5ans`
...
data_file[which(data_file$sus_arb == max(data_file$sus_arb, na.rm=T)),]
...
very_high_sus_arb <- filter(data_file, region == 'Amoron i Mania') 
