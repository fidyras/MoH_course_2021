...
## PART 1 ##
# Here you will be primarly introduced to several important concepts that we 
...
#This creates an object called *x* that contains the value 10
...
### A. WRITING IN R IS SIMILAR TO WRITING IN ENGLISH/FRENCH ###########################
